...
const HomePage = () => {
  ...
  return (
    <div className="home-page">
      ...
      {/* Categorías en Carrusel 3D */}
      <section className="carousels-section">
        <h2 className="section-title">Nuestras Delicias</h2>
        <p className="section-subtitle">Explora nuestras categorías y encuentra el postre perfecto</p>
        ...
        <div style={{ textAlign: 'center', fontSize: '0.8rem', color: 'gray', marginTop: '1rem', padding: '1rem', background: '#f5f0eb', borderRadius: '10px' }}>
